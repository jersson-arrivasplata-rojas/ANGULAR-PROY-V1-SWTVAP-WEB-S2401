...
!function(t, i) {
  ...
  var et = Object.assign || function(e) {
      for (var t = arguments.length, i = Array(1 < t ? t - 1 : 0), a = 1; a < t; a++)
          i[a - 1] = arguments[a];
  ...
  var Ot = {
      ...
      limitCanvas: function(t, i) {
          ...
          if (t) {
              ...
              1 < h ? (c = Math.max(c, a.width),
              d = Math.max(d, a.height),
              3 === h && (c < d * r ? c = d * r : d = c / r)) : 0 < h && (c ? c = Math.max(c, s ? o.width : 0) : d ? d = Math.max(d, s ? o.height : 0) : s && ((c = o.width) < (d = o.height) * r ? c = d * r : d = c / r));
              var l = Et({
                  aspectRatio: r,
                  width: c,
                  height: d
      ...
      limitCropBox: function(t, i) {
          ...
          if (t) {
              ...
              r && (s && c ? s < c * r ? c = s / r : s = c * r : s ? c = s / r : c && (s = c * r),
              d < l * r ? l = d / r : d = l * r),
      ...
      renderCropBox: function() {
          ...
          e.oldLeft = e.left,
          e.oldTop = e.top,
          t.movable && t.cropBoxMovable && pt(this.face, u, e.width >= i.width && e.height >= i.height ? W : k),
          ot(this.cropBox, et({
              width: e.width,
              height: e.height
          }, kt({
      ...
      output: function() {
          this.preview(),
          wt(this.element, a, this.getData())
      }
  }
    , zt = {
    ...
    , Yt = {
      bind: function() {
          ...
          i.zoomable && i.zoomOnWheel && vt(e, I, this.onWheel = this.wheel.bind(this)),
          i.toggleDragModeOnDblclick && vt(e, x, this.onDblclick = this.dblclick.bind(this)),
          vt(t.ownerDocument, C, this.onCropMove = this.cropMove.bind(this)),
          vt(t.ownerDocument, D, this.onCropEnd = this.cropEnd.bind(this)),
          i.responsive && vt(window, A, this.onResize = this.resize.bind(this))
      },
      unbind: function() {
          var t = this.element
            , i = this.options
    ...
    , Xt = {
      resize: function() {
          ...
          if (!(this.disabled || e.width <= a || e.height <= n)) {
              ...
              if (1 !== o || i.offsetHeight !== e.height) {
                  ...
                  this.render(),
                  t.restore && (this.setCanvasData(it(h, function(t, i) {
                      h[i] = t * o
                  })),
      ...
      dblclick: function() {
          var t, i;
          this.disabled || this.options.dragMode === f || this.setDragMode((t = this.dragBox,
          i = h,
          (t.classList ? t.classList.contains(i) : -1 < t.className.indexOf(i)) ? c : s))
      },
      wheel: function(t) {
          var i = this
      ...
      cropStart: function(t) {
          if (!this.disabled) {
              ...
              a = 1 < Object.keys(e).length && i.zoomable && i.zoomOnTouch ? E : lt(t.target, u),
              U.test(a) && !1 !== wt(this.element, b, {
                  originalEvent: t,
                  action: a
              }) && (t.preventDefault(),
              this.action = a,
      ...
      change: function(t) {
          ...
          case z:
              if (r) {
                  ...
                  B(O),
                  B(H),
                  0 <= D.x ? p < f ? d += D.x : D.y <= 0 && c <= g && (w = !1) : d += D.x,
                  D.y <= 0 ? g < c && (l -= D.y,
                  c += D.y) : (l -= D.y,
                  c += D.y);
              d < 0 && l < 0 ? (h = R,
          ...
          case X:
              if (r) {
                  ...
                  B(L),
                  B(H),
                  0 <= D.x ? p < f ? d += D.x : 0 <= D.y && v <= m && (w = !1) : d += D.x,
                  0 <= D.y ? m < v && (l += D.y) : l += D.y;
              d < 0 && l < 0 ? (h = Y,
              d = l = 0) : d < 0 ? (h = R,
              d = 0) : l < 0 && (h = z,
          ...
          case T:
              ...
              d = n.minWidth,
              l = n.minHeight,
              0 < D.x ? h = 0 < D.y ? X : z : D.x < 0 && (s -= d,
              h = 0 < D.y ? R : Y),
              D.y < 0 && (c -= l),
              this.cropped || (rt(this.cropBox, S),
              this.cropped = !0,
    ...
    , St = {
      ...
      reset: function() {
          return this.ready && !this.disabled && (this.imageData = et({}, this.initialImageData),
      ...
      destroy: function() {
          var t = this.element;
          return lt(t, l) && (this.isImg && this.replaced && (t.src = this.originalUrl),
          this.uncreate(),
          mt(t, l)),
          this
      },
      ...
      moveTo: function(t) {
          ...
          return t = Number(t),
          i = Number(i),
          this.ready && !this.disabled && this.options.movable && (K(t) && (e.left = t,
          a = !0),
          K(i) && (e.top = i,
          a = !0),
      ...
      zoomTo: function(t, i, e) {
          ...
          if (0 <= (t = Number(t)) && this.ready && !this.disabled && h.zoomable) {
              ...
              if (e) {
                  var u = this.pointers
                    , g = yt(this.cropper)
                    , f = u && Object.keys(u).length ? (o = n = a = 0,
                  it(u, function(t) {
                      var i = t.startX
                        , e = t.startY;
                      a += i,
                  ...
                  _(i) && K(i.x) && K(i.y) ? (r.left -= (p - s) * ((i.x - r.left) / s),
                  r.top -= (m - c) * ((i.y - r.top) / c)) : (r.left -= (p - s) / 2,
                  r.top -= (m - c) / 2);
              r.width = p,
              r.height = m,
              this.renderCanvas(!0)
      ...
      rotateTo: function(t) {
          return K(t = Number(t)) && this.ready && !this.disabled && this.options.rotatable && (this.imageData.rotate = t % 360,
      ...
      scale: function(t) {
          ...
          return t = Number(t),
          i = Number(i),
          this.ready && !this.disabled && this.options.scalable && (K(t) && (e.scaleX = t,
          a = !0),
          K(i) && (e.scaleY = i,
          a = !0),
      ...
      setData: function(t) {
          ...
          if (this.ready && !this.disabled && _(t)) {
              var o = !1;
              i.rotatable && K(t.rotate) && t.rotate !== e.rotate && (e.rotate = t.rotate,
              o = !0),
              i.scalable && (K(t.scaleX) && t.scaleX !== e.scaleX && (e.scaleX = t.scaleX,
              o = !0),
              K(t.scaleY) && t.scaleY !== e.scaleY && (e.scaleY = t.scaleY,
              o = !0)),
      ...
      setCanvasData: function(t) {
          var i = this.canvasData
            , e = i.aspectRatio;
          return this.ready && !this.disabled && _(t) && (K(t.left) && (i.left = t.left),
          K(t.top) && (i.top = t.top),
          K(t.width) ? (i.width = t.width,
          i.height = t.width / e) : K(t.height) && (i.height = t.height,
          i.width = t.height * e),
          this.renderCanvas(!0)),
          this
      },
      ...
      setCropBoxData: function(t) {
          var i = this.cropBoxData
            ...
            , a = void 0
            , n = void 0;
          return this.ready && this.cropped && !this.disabled && _(t) && (K(t.left) && (i.left = t.left),
          K(t.top) && (i.top = t.top),
          K(t.width) && t.width !== i.width && (a = !0,
          i.width = t.width),
          K(t.height) && t.height !== i.height && (n = !0,
          i.height = t.height),
      ...
      getCroppedCanvas: function() {
          ...
          if (!this.ready || !window.HTMLCanvasElement)
              return null;
          var i, e, a, n, o, h, r, s, c, d, l, p, m, u, g, f, v, w, b, x, y, M, C, D, B, k, T, W, E, H, N, L, O, z, Y, X, R, S, A, I, j, U = this.canvasData, P = (i = this.image,
          e = this.imageData,
          a = U,
          n = t,
          o = e.aspectRatio,
          ...
          L.drawImage.apply(L, [i].concat(bt(j.map(function(t) {
          ...
          at.imageSmoothingEnabled = ot,
          ht && (at.imageSmoothingQuality = ht);
          var rt = P.width
            , st = P.height
            , ct = $
            , dt = Q
            ...
            , gt = void 0
            , ft = void 0;
          ct <= -F || rt < ct ? gt = mt = lt = ct = 0 : ct <= 0 ? (mt = -ct,
          ct = 0,
          gt = lt = Math.min(rt, F + ct)) : ct <= rt && (mt = 0,
          gt = lt = Math.min(F, rt - ct)),
          lt <= 0 || dt <= -Z || st < dt ? ft = ut = pt = dt = 0 : dt <= 0 ? (ut = -dt,
          dt = 0,
          ft = pt = Math.min(st, Z + dt)) : dt <= st && (ut = 0,
          ft = pt = Math.min(Z, st - dt));
          var vt = [ct, dt, lt, pt];
          if (0 < gt && 0 < ft) {
              var wt = tt / F;
      ...
      setAspectRatio: function(t) {
          var i = this.options;
          return this.disabled || V(t) || (i.aspectRatio = Math.max(0, t) || NaN,
    ...
    , It = function() {
      ...
      return Z(e, [{
          ...
          value: function() {
              ...
              if (!lt(t, l)) {
                  ...
                  "img" === i) {
                      ...
                      "canvas" === i && window.HTMLCanvasElement && (e = t.toDataURL());
                  this.load(e)
              }
          }
      }, {
          ...
          value: function(t) {
              ...
              if (t) {
                  ...
                  if (a.checkOrientation && window.ArrayBuffer)
                      if (P.test(t))
                          q.test(t) ? this.read((n = t.replace(Nt, ""),
                          o = atob(n),
                          ...
                          ,
                          a.checkCrossOrigin && Dt(t) && e.crossOrigin && (t = Bt(t)),
                          s.open("get", t),
                          s.responseType = "arraybuffer",
                          s.withCredentials = "use-credentials" === e.crossOrigin,
                          s.send()
                      }
                  else
                      this.clone()
          ...
          key: "read",
          value: function(t) {
              var i, e, a, n = this.options, o = this.imageData, h = Lt(t), r = 0, s = 1, c = 1;
              if (1 < h) {
                  this.url = (i = "image/jpeg",
                  e = new Uint8Array(t),
                  a = "",
                  it(e, function(t) {
                      a += Ht(t)
          ...
          value: function() {
              var t = this.element
                ...
                , e = void 0
                , a = void 0;
              this.options.checkCrossOrigin && Dt(i) && ((e = t.crossOrigin) ? a = i : (e = "anonymous",
              a = Bt(i))),
              this.crossOrigin = e,
              ...
              this.onStart = o,
              this.onStop = h,
              this.isImg ? t.complete ? this.timeout = setTimeout(o, 0) : vt(t, y, o, {
                  once: !0
              }) : (n.onload = o,
              n.onerror = h,
              ht(n, p),
          ...
          value: function(t) {
              ...
              if (!i.naturalWidth || a) {
                  ...
                  ,
                  o.src = i.src,
                  a || (o.style.cssText = "left:0;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;opacity:0;position:absolute;top:0;z-index:-1;",
                  h.appendChild(o))
              } else
          ...
          value: function() {
              if (this.sized && !this.ready) {
                  ...
                  i.cropBoxMovable && (ht(c, m),
                  pt(c, u, k)),
                  i.cropBoxResizable || (ht(s.getElementsByClassName(l + "-line"), S),
          ...
          value: function() {
              ...
              this.sizing = !1,
              this.sized = !1) : this.reloading ? this.xhr.abort() : this.isImg ? t.complete ? clearTimeout(this.timeout) : ft(t, y, this.onStart) : this.image && this.stop()
          }
      }], [{
          key: "noConflict",
          value: function() {
              return window.Cropper = At,
              e
          }
      }, {
          key: "setDefaults",
  ...
  if (et(It.prototype, Ot, zt, Yt, Xt, Rt, St),
  d.fn) {
      var jt = d.fn.cropper
        , Ut = "cropper";
      d.fn.cropper = function(r) {
          for (var t = arguments.length, s = Array(1 < t ? t - 1 : 0), i = 1; i < t; i++)
              s[i - 1] = arguments[i];
          var c = void 0;
          return this.each(function(t, i) {
              ...
              if ("string" == typeof r) {
                  var h = n[r];
                  d.isFunction(h) && ((c = h.apply(n, s)) === n && (c = void 0),
                  a && e.removeData(Ut))
              }
          }),
          void 0 !== c ? c : this
