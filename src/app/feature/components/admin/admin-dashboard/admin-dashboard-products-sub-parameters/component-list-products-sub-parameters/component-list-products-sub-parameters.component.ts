...
@Component({
  selector: 'swtvap-component-list-products-sub-parameters',
  templateUrl: './component-list-products-sub-parameters.component.html',
  styleUrls: ['./component-list-products-sub-parameters.component.scss'],
})
export class ComponentListProductsSubParametersComponent {
