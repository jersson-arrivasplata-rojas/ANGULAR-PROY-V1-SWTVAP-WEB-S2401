...
export class ResourcesUtils{
  ...
  public static EsEntregado = 'Entregado';
  public static EsFacturaDe = 'Factura de';
  ...
  public static EsNuevosClientes = 'Nuevos clientes';
  public static EsCantidadClientes = 'Cantidad de Clientes';
  ...
  public static EsOrdenes = 'Ordenes';
  public static EsLikes = 'Likes';
 ...
 //https://www.facebook.com/snapstore.pe/

  // Recursos en Ingles
  public static EnVersion = 'Version 1.1';
  public static EnInicio = 'Home';

  public static EnImprimirFactura = 'Print Invoice';
  public static EnPedidoInformacion = 'Order Info';
  public static EnPedidoEstado = 'Order status';
  public static EnPedidoFecha = 'Order date';
  public static EnEditar = 'Edit';
  public static EnNumeroOrden = 'Order Number';
  public static EnGuardar = 'Save';
  public static EnPendiente = 'Pending';
  public static EnProcesando = 'Processing';
  public static EnEntregado = 'Delivered';
  public static EnFacturaDe = 'Bill From';
  ...
  public static EnNuevosClientes = 'New customers';
  public static EnCantidadClientes = 'Number of Clients';
  public static EnAnoAnterior = 'Last year';
  public static EnMesAnterior = 'Last month';
  public static EnSemanaAnterior = 'Last week';
  public static EnDiaAnterior = 'Last day';
  public static EnVentaAno = 'Sale of the year';
  public static EnVentaMes = 'Sale of the month';
  public static EnVentaSemana = 'Sale of the week';
  public static EnVentaDia = 'Sale of the day';
  public static EnVisitas = 'Visits';
  public static EnMegustas = 'Likes';
  public static EnCompartidos = 'Shareds';

  public static EnOrdenes = 'Orders';
  public static EnLikes = 'Likes';
  public static EnComentarios = 'Comments';
  public static EnFechaYHora = 'Current Date and Time';
  public static EnSeguidores = 'Leads';
  public static EnVenta20UltimosDias = 'Last 20 Day Sales';
  public static EnAddWidgets = 'Add News Widgets';
